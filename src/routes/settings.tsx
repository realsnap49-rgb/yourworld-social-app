...
function Toggle({
  ...
  return (
    <button
      ...
      className={cn(
        "relative h-[28px] w-[48px] shrink-0 rounded-full transition-all duration-300 focus-visible:outline-none active:scale-95",
        checked
          ? (accent ?? "bg-primary")
...
function Divider() {
  return (
    <div className="hairline -mx-4 my-3.5 border-t" />
  );
}

/* ── Row (chevron link style) ── */
function ActionRow({
  label,
  hint,
  onClick,
    ...
    <main className="grain relative min-h-screen pb-28">
      ...
      <div className="space-y-5 px-4 pt-5">
        ...
        <div className="flex flex-col items-center pb-1 pt-2">
          ...
          <p className="mt-3 font-ui text-[15px] font-semibold text-foreground">
            {name}
          </p>
        ...
        <Section icon={Lock} title="Security">
          ...
          <Divider />
          <ActionRow label="Active Sessions" hint="Review where you're logged in" />
        </Section>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-1 items-center justify-between gap-4">
              <div>
                ...
                <p className="font-ui text-[12px] text-muted-foreground">
                  {igOn ? "Connected as @you" : "Not connected"}
                </p>
              </div>
              <Toggle
                checked={igOn}
        ...
        <div className="surface-card overflow-hidden rounded-[22px]">
          ...
          >
            ...
            <span className="font-ui text-[14px] font-medium text-foreground">
              Log Out
            </span>
        ...
        <Section icon={Trash2} title="Danger Zone" danger>
          <div className="space-y-3">
            <p className="font-ui text-[13px] leading-relaxed text-muted-foreground">
              Once you delete your account, all your moments, posts, and data
